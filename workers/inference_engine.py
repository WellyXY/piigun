...
DEFAULT_PROMPTS = {
    ...
    "lift_clothes": "A female lifts her shirt up slowly to fully expose her bare breasts. As the fabric rises, her round, natural breasts are revealed with soft, smooth skin and clearly visible erect nipples — small, pink, and perky, standing out distinctly from her areolas. She cups both breasts with her hands, lifting and squeezing them gently, her fingers pressing into the soft flesh. She then jiggles them with a slow, bouncing motion, the natural weight of her breasts swaying with each movement, her nipples remaining prominently erect throughout. The camera is static, medium shot, front view. Her expression is subtly aroused, lips slightly parted.",
    ...
    "cumshot": "A close-up POV view of male ejaculation. An erect penis is positioned near the woman's face. Slightly translucent milky-white semen with subtle pearlescent sheen spurts from the urethral opening at the tip of the penis in rhythmic pulses. Streams of cum travel through the air, catching light with faint translucency, and land on the woman's lips, chin, and cheeks. Realistic liquid viscosity with natural translucency, not opaque paint-white. ltxmove_cumshot",
}
...
DEFAULT_PROMPTS_AUDIO = {
    ...
    "cumshot": 'A close-up POV view of male ejaculation. An erect penis is positioned near the woman\'s face, rhythmic pulsing sounds building with urgent anticipation. She moans eagerly, begging "give me more" and "cum all over my face" in a hungry desperate voice, her tongue out waiting. Slightly translucent milky-white semen with subtle pearlescent sheen spurts from the urethral opening at the tip of the penis in rhythmic pulses. Streams of cum travel through the air with wet splashing sounds, catching light with faint translucency, landing on the woman\'s lips, chin, and cheeks as she gasps "yes, yes, yes". She whimpers "it\'s so warm" and "please don\'t stop", breath catching with each pulse. Soft cries of "fuck me" and "I want it all" mix with satisfied moans, her lips parting hungrily to catch every drop. Realistic liquid viscosity with natural translucency, not opaque paint-white. ltxmove_cumshot',
}
