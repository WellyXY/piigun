...
DEFAULT_PROMPTS = {
    ...
    "lift_clothes": "A female grips the hem of her shirt with both hands and pulls the fabric upward in a smooth motion, lifting the top up her torso until her breasts are fully exposed with clearly visible pink nipples and defined areolas underneath. She then cups and gently jiggles her breasts with both hands, her natural nipple texture clearly detailed. Front view medium shot, static camera, moderately paced. --lift_clothes",
