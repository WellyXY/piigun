...
DEFAULT_AUDIO = {
    ...
    "cumshot":    "rhythmic pulsing sounds, she moans softly with anticipation, whispering \"cum for me\" and \"yes\" in a breathy voice, wet splashing sounds as cum lands, her breath catches with each pulse, soft gasps of satisfaction.",
}
...
DEFAULT_PROMPTS_AUDIO = {
    ...
    "cumshot": 'A close-up POV view of male ejaculation. An erect penis is positioned near the woman\'s face, rhythmic pulsing sounds building with anticipation. She moans softly, whispering "cum for me" and "yes" in a breathy voice. White semen spurts from the urethral opening at the tip of the penis in rhythmic pulses. Streams of cum travel through the air with wet splashing sounds, landing on the woman\'s lips, chin, and cheeks. Her breath catches with each pulse, soft gasps of satisfaction escaping her lips. Realistic liquid viscosity. ltxmove_cumshot',
}
